    ...
    <section className="relative w-full min-h-[650px] flex items-center overflow-hidden bg-[#00070D] font-satoshi">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-12 w-full text-left py-20">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <span className="text-[#00E5FF] text-sm font-semibold">
        ...
        <div className="max-w-5xl space-y-1">
          ...
          <h1 className="text-[#F5AB40] text-4xl md:text-5xl lg:text-6xl font-black leading-tight tracking-tight">
        ...
        <div className="mt-14 space-y-5 text-white">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-xl uppercase tracking-tighter">February 20, 2026</span>
          </div>
          <div className="flex items-center gap-3">
            <MapPin size={22} className="text-white" />
            <span className="font-medium text-lg italic opacity-95">
